<?php
    $title="Accueil - Educ-Action";
    include('./app/Commun/page_header.php');;
?>
  ...
  <section id="hero" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
      ...
      <h2>Nous formons les meilleurs cardres pour l'avenir</h2>
      <a href="#" class="btn-get-started">Commencez</a>
    </div>
  </section><!-- End Hero -->
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="content">
              <h3>Pourquoi nous Choisir Educ-action?</h3>
              <p>
