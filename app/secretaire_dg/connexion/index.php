...
$title = "Connexion - Sécrétaire du directeur générale";
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="p-5">
                                ...
                                <form class="user" action="<?= CHEMIN_PROJET ?>secretaire_dg/connexion/traitement" method="post">
                                ...
                                <hr>
                                <div class="text-center">
                                    <a class="small" href="<?= CHEMIN_PROJET ?>secretaire_dg/mot_de_passe_oublie/">Mot de passe oublié ?</a>
                                </div>
                                <div class="text-center">
                                    <a class="small" href="<?= CHEMIN_PROJET ?>secretaire_dg/inscription/">Créez un compte!</a>
                                </div>
                            </div>
                        </div>
                    </div>
