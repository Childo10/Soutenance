...
if (isset($_SESSION['users_SDG']) and !empty($_SESSION['users_SDG'])) {
    header('location:/soutenance/secretaire_dg/dashbord/');
}

$title = "Mot de passe oublié - Sécrétaire du directeur générale";
...
<?php
unset($_SESSION['changement-message-success-global'],$_SESSION['changement-message-erreur-global']);
