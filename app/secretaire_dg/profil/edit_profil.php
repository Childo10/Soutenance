...
if (isset($_SESSION['users_SDG']['id_utilisateur']) and !empty($_SESSION['users_SDG']['id_utilisateur'])) {
}
...
<div class="container">
	...
	<div class="main-body">
		<div class="col-lg-8 offset-md-2 offset-0">
			...
			<form class="card" method="post" action="<?= CHEMIN_PROJET ?>secretaire_dg/profil/edit_profil_traitement">
				...
				<div class="card-body">
					<div class="row mb-3">
						...
						<div class="col-sm-9 text-secondary">
							<input type="text" name="nom" class="form-control <?= isset($_SESSION['errors']['nom']) ? 'is-invalid' : '' ?>" value="<?= $_SESSION['users_SDG']['nom'] ?>">
							<?php
					...
					<div class="row mb-3">
						...
						<div class="col-sm-9 text-secondary">
							<input type="text" name="prenom" class="form-control <?= isset($_SESSION['errors']['prenom']) ? 'is-invalid' : '' ?>" value="<?= $_SESSION['users_SDG']['prenom'] ?>">
							<?php
					...
					<div class="row mb-3">
						...
						<div class="col-sm-9 text-secondary">
							<input type="text" name="nom_utilisateur" class="form-control <?= isset($_SESSION['errors']['nom_utilisateur']) ? 'is-invalid' : '' ?>" value="<?= $_SESSION['users_SDG']['nom_utilisateur'] ?>">
							<?php
					...
					<div class="row mb-3">
						...
						<div class="col-sm-9 text-secondary">
							<input type="date" name="date_naissance" class="form-control <?= isset($_SESSION['errors']['date_naissance']) ? 'is-invalid' : '' ?>"  value="<?= !empty($_SESSION['users_SDG']['date_naissance']) ? $_SESSION['users_SDG']['date_naissance'] : ''?>">
							<?php
					...
					<div class="row mb-3">
						...
						<div class="col-sm-9 text-secondary">
							<input type="text" name="adresse" class="form-control <?= isset($_SESSION['errors']['adresse']) ? 'is-invalid' : '' ?>" value="<?= !empty($_SESSION['users_SDG']['adresse']) ? $_SESSION['users_SDG']['adresse'] : ''?>">
							<?php
					...
					<div class="row mb-3">
						...
						<div class="col-sm-9 text-secondary">
							<input type="number" name="telephone" class="form-control <?= isset($_SESSION['errors']['telephone']) ? 'is-invalid' : '' ?>" value="<?= !empty($_SESSION['users_SDG']['telephone']) ? $_SESSION['users_SDG']['telephone'] : ''?>">
							<?php
