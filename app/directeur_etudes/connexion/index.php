                             ...
                             <div class="p-5">
                                 ...
                                 <form action="<?= CHEMIN_PROJET ?>directeur_etudes/connexion/traitement" method="post" class="user">
                                     <div class="form-group">
                                         <label for="email">Entrer votre email <span class="text-danger">(*)</span></label>
                                     ...
                                     <div class="form-group">
                                         <label for="mot_de_passe">Entrer votre mot de passe <span class="text-danger">(*)</span> </label>
