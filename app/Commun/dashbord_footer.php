  ...
  <footer class="sticky-footer bg-white">
    ...
    <script src="/soutenance/public/js/sb-admin-2.min.js"></script>
      <!-- Page level plugins -->
      <script src="/soutenance/public/vendor/datatables/jquery.dataTables.min.js"></script>
    <script src="/soutenance/public/vendor/datatables/dataTables.bootstrap4.min.js"></script>
