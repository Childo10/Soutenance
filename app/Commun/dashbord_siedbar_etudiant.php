...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= CHEMIN_PROJET ?>etudiant/dashbord/">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="<?= CHEMIN_PROJET ?>etudiant/dashbord/">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= CHEMIN_PROJET ?>etudiant/dashbord/matiere">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= CHEMIN_PROJET ?>etudiant/dashbord/emploi_temps">
                    <i class="fas fa-fw fa-calendar"></i>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= CHEMIN_PROJET ?>etudiant/pages/">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item" href="<?= CHEMIN_PROJET ?>etudiant/profil/">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="<?= CHEMIN_PROJET ?>etudiant/dashbord/deconnexion">Déconnexion</a>
            </div>
        </div>
    </div>
</div>