...
<head>
    ...
    <title>Connexion - Sécrétaire du DG</title>
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            ...
                            <form class="user">
                                ...
                                <a href="dashbord_SDG.php" class="btn btn-primary btn-user btn-block">
                                    Connectez-vous
                                </a>
                                <hr>
                            </form>
                            <hr>
                            <div class="text-center">
                                <a class="small" href="mdp_oublie_SDG.php">Mot de passe oublié ?</a>
                            </div>
                            <div class="text-center">
                                <a class="small" href="inscription_SDG.php">Créez un compte!</a>
                            </div>
                        </div>
                    </div>
                </div>
