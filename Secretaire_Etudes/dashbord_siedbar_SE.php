...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashbord_SE.php">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="dashbord_SE.php">
            ...
            <li class="nav-item">
                ...
                <div id="collapsecours" class="collapse" aria-labelledby="cours" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="Ajout_derou_cours_SE.php">Ajouter un dérouler cours</a>
                        <a class="collapse-item" href="Liste_derou_cours_SE.php">Liste des dérouler cours </a>
                    </div>
                </div>
            </li>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item" href="profil_SE.php">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="connexion_SE.php">Déconnexion</a>
            </div>
        </div>
    </div>
</div>