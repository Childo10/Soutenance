...
<head>
    ...
    <link rel="stylesheet" href="../public/css/profil_style.css">
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashbord_DE.php">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="dashbord_DE.php">
        ...
        <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <div id="collapseProfesseur" class="collapse" aria-labelledby="headingProfesseur"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="Ajout_professeur_DE.php">Ajouter un professeur</a>
                        <a class="collapse-item" href="Liste_professeur_DE.php">Liste des professeurs</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsefiliere" class="collapse" aria-labelledby="headingfiliere" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="Ajout_filière_DE.php">Ajouter une filière</a>
                        <a class="collapse-item" href="Liste_filière_DE.php">Liste des filières</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsematiere" class="collapse" aria-labelledby="matiere" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="Ajout_matière_DE.php">Ajouter une matière</a>
                        <a class="collapse-item" href="Liste_matière_DE.php">Liste des matières</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsecours" class="collapse" aria-labelledby="cours" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="Ajout_derou_cours_DE.php">Ajouter un dérouler cours</a>
                        <a class="collapse-item" href="Liste_derou_cours_DE.php">Liste des dérouler cours </a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsesalle" class="collapse" aria-labelledby="salle" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="Ajout_salle_DE.php">Ajouter une salle</a>
                        <a class="collapse-item" href="Liste_salle_DE.php">Liste salles </a>
                    </div>
                </div>
            </li>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="mr-2 d-none d-lg-inline text-gray-600 small">Michel Houedanou</span>
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                    ...
                    <a class="dropdown-item" href="profil_DE.php">
...
<div class="modal-content">
    ...
    <div class="modal-footer">
        ...
        <a class="btn btn-primary" href="connexion_DE.php">Déconnexion</a>
    </div>
</div>
</div>
</div>