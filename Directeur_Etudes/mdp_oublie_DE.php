...
<head>
    ...
    <title>Mot de passe oublié - Directeur des études</title>
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            ...
                            <form class="user">
                                ...
                                <a href="connexion_DE.php" class="btn btn-primary btn-user btn-block">
                            ...
                            <div class="text-center">
                                <a class="small" href="connexion_DE.php">Vous avez déjà un compte ? Connectez-vous!</a>
                            </div>
                        </div>
                    </div>
                </div>
